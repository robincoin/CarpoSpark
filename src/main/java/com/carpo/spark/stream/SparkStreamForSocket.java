 ...
 *
 */
public class SparkStreamForSocket {
    public static void main(String[] args) {

        // Create a local StreamingContext with two working thread and batch
        // interval of 1 second
        SparkConf conf = new SparkConf().setAppName("WordCountLocal").setMaster("local").set("spark.testing.memory",
                "2147480000");
        ...
        wordCounts.dstream().saveAsTextFiles("e://spark.txt", "spark");
